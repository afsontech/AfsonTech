"""
Django settings for afsontech_web project.
...
BASE_DIR = Path(__file__).resolve().parent.parent  # Single consistent definition
...
ROOT_URLCONF = 'afsontech_web.urls'
...
WSGI_APPLICATION = 'afsontech_web.wsgi.application'
